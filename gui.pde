...
public void createGUI(){
  ...
  window1 = GWindow.getWindow(this, "Control Panel", 0, 0, 630, 400, JAVA2D);
  window1.noLoop();
  ...
  SharkSpeedSlider = new GCustomSlider(window1, 10, 30, 100, 40, "red_yellow18px");
  SharkSpeedSlider.setLimits(0, -5, 5);
  SharkSpeedSlider.setNbrTicks(10);
  SharkSpeedSlider.setNumberFormat(G4P.INTEGER, 0);
  SharkSpeedSlider.setLocalColorScheme(GCScheme.GOLD_SCHEME);
  ...
  TurtleSpeedSlider = new GCustomSlider(window1, 120, 30, 100, 40, "red_yellow18px");
  TurtleSpeedSlider.setLimits(0, -5, 5);
  TurtleSpeedSlider.setNbrTicks(10);
  TurtleSpeedSlider.setNumberFormat(G4P.INTEGER, 0);
  TurtleSpeedSlider.setLocalColorScheme(GCScheme.GREEN_SCHEME);
  ...
  OctopusSpeedSlider.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  OctopusSpeedSlider.setOpaque(false);
  OctopusSpeedSlider.addEventHandler(this, "OctopusSpeedSliderChanged");
  JellyfishSpeedSlider = new GCustomSlider(window1, 340, 30, 100, 40, "purple18px");
  ...
  JellyfishSpeedSlider.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  JellyfishSpeedSlider.setOpaque(false);
  JellyfishSpeedSlider.addEventHandler(this, "JellyfishSpeedSliderChanged");
  FishSpeedSlider = new GCustomSlider(window1, 450, 30, 100, 40, "blue18px");
  ...
  SharkVisionSlider = new GCustomSlider(window1, 10, 80, 100, 40, "red_yellow18px");
  SharkVisionSlider.setLimits(1, 1, 5);
  SharkVisionSlider.setNbrTicks(5);
  SharkVisionSlider.setNumberFormat(G4P.INTEGER, 0);
  SharkVisionSlider.setLocalColorScheme(GCScheme.GOLD_SCHEME);
  SharkVisionSlider.setOpaque(false);
  SharkVisionSlider.addEventHandler(this, "SharkVisionSliderChanged");
  SharkReproductionSlider = new GCustomSlider(window1, 10, 130, 100, 40, "red_yellow18px");
  ...
  TurtleReproductionSlider.setLocalColorScheme(GCScheme.GREEN_SCHEME);
  ...
  OctopusVisionSlider.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  ...
  OctopusReproductionSlider.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
  OctopusReproductionSlider.setOpaque(false);
  OctopusReproductionSlider.addEventHandler(this, "OctopusReproduceChanged");
  JellyfishVisionSlider = new GCustomSlider(window1, 340, 80, 100, 40, "purple18px");
  ...
  JellyfishVisionSlider.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  JellyfishVisionSlider.setOpaque(false);
  JellyfishVisionSlider.addEventHandler(this, "JellyfishVisionSliderChanged");
  JellyfishReproductionSlider = new GCustomSlider(window1, 340, 130, 100, 40, "purple18px");
  ...
  JellyfishReproductionSlider.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  JellyfishReproductionSlider.setOpaque(false);
  JellyfishReproductionSlider.addEventHandler(this, "JellyfishReproductionChanged");
  FishVisionSlider = new GCustomSlider(window1, 450, 80, 100, 40, "blue18px");
  ...
  FishReproductionSlider = new GCustomSlider(window1, 450, 130, 100, 40, "blue18px");
